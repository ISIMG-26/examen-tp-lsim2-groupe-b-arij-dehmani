...
CREATE TABLE if NOT EXISTS produits(
    ...
    image VARCHAR(255) DEFAULT 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&q=80',
    categorie_id INT NOT NULL,
    stock INT DEFAULT 10,
    disponible TINYINT(1) DEFAULT 1, --vu que mysql ma aandesh boolean type, nestaamlu tinyint(1) par deafut 1 diqpo
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- en cas de modification 
...
--les donnees sont prenues en tant que exemple pret de l internet 
...
('admin', 'admin','admin@coffeshop.com','admin123', 'admin');